      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <Link
              to={isAuthenticated ? '/timeline' : '/register'}
          ...
          <motion.div
            ...
            className="card relative border-4 border-primary-500 dark:border-primary-600"
          >
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <span className="premium-badge px-4 py-2">
